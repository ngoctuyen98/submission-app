...
const submissionSchema = z.object({
  ...
  score: z
    ...
    .refine((val) => !isNaN(val), "Điểm phải là số")
    .refine((val) => val >= 0, "Điểm phải từ 0 trở lên")
    .refine((val) => val <= 100, "Điểm không được quá 100"),
  time: z
    .string()
    .transform((val) => parseInt(val, 10))
    .refine((val) => !isNaN(val), "Thời gian phải là số")
    .refine((val) => val >= 1, "Thời gian phải lớn hơn 0")
    .refine((val) => val <= 3600, "Thời gian không được quá 3600 giây"),
});
